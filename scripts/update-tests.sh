...
fontforge ../scripts/fontconvert AyannaNarrowTamil-Light.sfd --otf --correct-directions --remove-overlap --round-points
fontforge ../scripts/fontconvert AyannaNarrowTamil-ExtraBold.sfd --otf --correct-directions --remove-overlap --round-points
